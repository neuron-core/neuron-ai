...
class TaskCompletionJudgeTest extends TestCase
{
    ...
    public function test_passes_when_goal_accomplished(): void
    {
    ...
    public function test_fails_when_goal_missed(): void
    {
    ...
    public function test_prompt_carries_goal_and_transcript(): void
    {
