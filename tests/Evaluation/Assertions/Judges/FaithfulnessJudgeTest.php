...
class FaithfulnessJudgeTest extends TestCase
{
    ...
    public function test_passes_when_output_is_grounded_in_context(): void
    {
    ...
    public function test_fails_when_output_contains_hallucination(): void
    {
    ...
    public function test_passes_with_only_context_information(): void
    {
    ...
    public function test_fails_when_adding_external_information(): void
    {
    ...
    public function test_includes_context_in_prompt(): void
    {
        $fakeProvider = FakeAIProvider::make();
        for ($i = 0; $i < 3; $i++) {
    ...
    public function test_uses_faithfulness_criteria(): void
    {
        $fakeProvider = FakeAIProvider::make();
        for ($i = 0; $i < 3; $i++) {
            $fakeProvider->addResponses(new AssistantMessage(json_encode([
