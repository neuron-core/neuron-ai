...
class HelpfulnessJudgeTest extends TestCase
{
    ...
    public function test_passes_when_output_is_helpful(): void
    {
    ...
    public function test_fails_when_output_is_not_actionable(): void
    {
    ...
    public function test_passes_with_complete_answer(): void
    {
    ...
    public function test_fails_with_evasive_answer(): void
    {
    ...
    public function test_uses_helpfulness_criteria(): void
    {
        $fakeProvider = FakeAIProvider::make();
        for ($i = 0; $i < 3; $i++) {
