...
class EvaluationSuiteSummaryTest extends TestCase
{
    public function test_preserves_order_empty_evaluators_and_wall_clock_time(): void
    {
        ...
        $this->assertSame($emptySummary, $reports[1]->getSummary());
        ...
        $this->assertCount(1, $suite->getAggregateSummary()->getResults());
        $this->assertSame(3.75, $suite->getAggregateSummary()->getTotalExecutionTime());
    }
    ...
    public function test_evaluator_error_fails_suite_without_creating_item_failure(): void
    {
        ...
        $this->assertFalse($suite->getAggregateSummary()->hasFailures());
    ...
    public function test_repeated_evaluator_classes_remain_distinct_reports(): void
    {
        ...
        $this->assertEqualsWithDelta(0.3, $suite->getAggregateSummary()->getTotalExecutionTime(), 0.001);
    }
