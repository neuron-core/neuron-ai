...
class DeserializerTest extends TestCase
{
    ...
    public function test_deserialize_multi_type_array_with_discriminator(): void
    {
        ...
        $this->assertInstanceOf(\NeuronAI\Tests\StructuredOutput\Stub\FtpMode::class, $obj->modes[0]);
        $this->assertEquals('ftp', $obj->modes[0]->mode);
        $this->assertEquals('user123', $obj->modes[0]->account);

        // Second item should be EmailMode
        $this->assertInstanceOf(\NeuronAI\Tests\StructuredOutput\Stub\EmailMode::class, $obj->modes[1]);
        ...
        $this->assertInstanceOf(\NeuronAI\Tests\StructuredOutput\Stub\FtpMode::class, $obj->modes[2]);
    ...
    public function test_deserialize_multi_type_array_with_anyof(): void
    {
        ...
        $this->assertInstanceOf(\NeuronAI\Tests\StructuredOutput\Stub\ImageBlock::class, $obj->blocks[0]);
        ...
        $this->assertInstanceOf(\NeuronAI\Tests\StructuredOutput\Stub\TextBlock::class, $obj->blocks[1]);
