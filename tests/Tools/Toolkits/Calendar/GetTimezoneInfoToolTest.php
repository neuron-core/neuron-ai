...
class GetTimezoneInfoToolTest extends TestCase
{
    ...
    public function test_get_timezone_info_current_time(): void
    {
    ...
    public function test_get_timezone_info_with_location(): void
    {
    ...
    public function test_get_timezone_info_all_fields(): void
    {
