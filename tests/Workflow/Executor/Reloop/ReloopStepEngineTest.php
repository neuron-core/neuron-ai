...
class ReloopStepEngineTest extends TestCase
{
    ...
    /**
     * Simulate the Reloop platform replay loop.
     *
     * Step::run() executes the callback on the first encounter, records the result,
    ...
    private function replayWithHandler(Workflow $workflow, ?Closure $executorFactory = null): WorkflowState
    {
        ...
        for ($i = 0; $i < 20; $i++) {
            ...
            $handler = new ReloopTaskHandler($workflow, executorFactory: $executorFactory);
