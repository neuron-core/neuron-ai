 ...
 * as a constructor dependency and updated when the agent replaces its history.
 * Middleware access it through the node they wrap so they always see the
 * instance the node reads and writes.
 */
